...
@checker.define_vuln(flag_id_description='flag_id is dialogue_id (hex)', vuln_rate=1)
class DialogueChecker(VulnChecker):
    ...
    def put(request: PutRequest) -> Verdict:
        ...
        return Verdict.OK_WITH_FLAG_ID(f'dialogue_id: {dialogue_id.hex()}', flag_id)
...
@checker.define_vuln(flag_id_description='flag_id is msg_id (hex)')
class MessageChecker(VulnChecker):
    ...
    def put(request: PutRequest) -> Verdict:
        ...
        return Verdict.OK_WITH_FLAG_ID(f'msg_id: {msg_id.hex()}', flag_id)
