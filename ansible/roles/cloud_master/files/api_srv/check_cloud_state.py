...
from cloud_common import log_progress, call_unitl_zero_exit, SSH_OPTS, SSH_YA_OPTS, DOMAIN
...
def main():
    ...
    do_dns_records = ya_api.get_all_domain_records(DOMAIN)
